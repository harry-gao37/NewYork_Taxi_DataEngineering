...
export MODEL_BUCKET_PROD="stg-mlflow-models-code-owners-yifu"
export PREDICTIONS_STREAM_NAME="stg_ride_predictions-yifu"
export LAMBDA_FUNCTION="stg_prediction_lambda_yifu"

# Model artifacts bucket from the previous weeks (MLflow experiments)
export MODEL_BUCKET_DEV="mlflow-models-yifu"
